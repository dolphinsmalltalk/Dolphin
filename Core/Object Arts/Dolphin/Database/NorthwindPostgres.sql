-- Note that the table and column names here are mixed-case  as in the original Northwind DB. 
-- Postgres has the rather annoying feature that it translates all unquoted names to lowercase 
-- and there does not appear to be an option to change this behaviour. Since we are using this
-- for testing in a set of tests that are common across a range of DBMSs, it just about pays
-- off to quote all the identifiers, but I would think this might be rather tedious in practice.
...
CREATE TABLE "CustomerDemographics" (
    "CustomerTypeID" character varying(5) PRIMARY KEY,
...
CREATE TABLE "Customers" (
    "CustomerID" character(5) PRIMARY KEY,
...
CREATE TABLE "Territories" (
    "TerritoryID" character varying(20) PRIMARY KEY,
...
INSERT INTO "Employees" VALUES (2, 'Fuller', 'Andrew', 'Vice President, Sales', 'Dr.', '1952-02-19', '1992-08-14', '908 W. Capital Way', 'Tacoma', 'WA', '98401', 'USA', '(206) 555-9482', '3457', '\x', 'Andrew received his BTS commercial in 1974 and a Ph.D. in international marketing "from the "University of Dallas in 1981.  He is fluent in French and Italian and reads German.  He joined the company as a sales representative, was promoted to sales manager in January 1992 and to vice president of sales in March 1993.  Andrew is a member of the Sales Mana"gement Ro"undtable, the Seattle Chamber of Commerce, and the Pacific Rim Importers Association.', NULL, 'http://accweb/emmployees/fuller.bmp');
INSERT INTO "Employees" VALUES (3, 'Leverling', 'Janet', 'Sales Representative', 'Ms.', '1963-08-30', '1992-04-01', '722 Moss Bay Blvd.', 'Kirkland', 'WA', '98033', 'USA', '(206) 555-3412', '3355', '\x', 'Janet has a BS degree in chemistry from Boston College (1984).  She has also compl"eted a c"ertificate program in food retailing management.  Janet was hired as a sales associate in 1991 and promoted to sales representative in February 1992.', 2, 'http://accweb/emmployees/leverling.bmp');
INSERT INTO "Employees" VALUES (4, 'Peacock', 'Margaret', 'Sales Representative', 'Mrs.', '1937-09-19', '1993-05-03', '4110 Old Redmond Rd.', 'Redmond', 'WA', '98052', 'USA', '(206) 555-8122', '5176', '\x', 'Margaret holds a BA in English literature from Concordia College (1958) and" an MA fr"om the American Institute of Culinary Arts (1966).  She was assigned to the London office temporarily from July through November 1992.', 2, 'http://accweb/emmployees/peacock.bmp');
INSERT INTO "Employees" VALUES (5, 'Buchanan', 'Steven', 'Sales Manager', 'Mr.', '1955-03-04', '1993-10-17', '14 Garrett Hill', 'London', NULL, 'SW1 8JR', 'UK', '(71) 555-4848', '3453', '\x', 'Steven Buchanan graduated from St. Andrews University, Scotland, with a BSC degree in 1976.  "Upon join"ing the company as a sales representative in 1992, he spent 6 months in an orientation program at the Seattle office and then returned to his permanent post in London.  He was promoted to sales manager in March 1993.  Mr. Buchanan has completed the courses Su"ccessful "Telemarketing and International Sales Management.  He is fluent in French.', 2, 'http://accweb/emmployees/buchanan.bmp');
INSERT INTO "Employees" VALUES (6, 'Suyama', 'Michael', 'Sales Representative', 'Mr.', '1963-07-02', '1993-10-17', 'Coventry House\nMiner Rd.', 'London', NULL, 'EC2 7JR', 'UK', '(71) 555-7773', '428', '\x', 'Michael is a graduate of Sussex University (MA, economics, 1983) and the Univer"sity of "California at Los Angeles (MBA, marketing, 1986).  He has also taken the courses Multi-Cultural Selling and Time Management for the Sales Professional.  He is fluent in Japanese and can read and write French, Portuguese, and Spanish.', 5, 'http://accweb/emmployees"/d"avolio.bmp');
INSERT INTO "Employees" VALUES (7, 'King', 'Robert', 'Sales Representative', 'Mr.', '1960-05-29', '1994-01-02', 'Edgeham Hollow\nWinchester Way', 'London', NULL, 'RG1 9SP', 'UK', '(71) 555-5598', '465', '\x', 'Robert King served in the Peace Corps and traveled extensively before com"pleting h"is degree in English at the University of Michigan in 1992, the year he joined the company.  After completing a course entitled Selling in Europe, he was transferred to the London office in March 1993.', 5, 'http://accweb/emmployees/davolio.bmp');
INSERT INTO "Employees" VALUES (8, 'Callahan', 'Laura', 'Inside Sales Coordinator', 'Ms.', '1958-01-09', '1994-03-05', '4726 - 11th Ave. N.E.', 'Seattle', 'WA', '98105', 'USA', '(206) 555-1189', '2344', '\x', 'Laura received a BA in psychology from the University of Washington".  She ha"s also completed a course in business French.  She reads and writes French.', 2, 'http://accweb/emmployees/davolio.bmp');
...
INSERT INTO "Products"  VALUES (1, 'Chai', 8, 1, '10 boxes x 30 bags', 18, 39, 0, 10, true);
INSERT INTO "Products"  VALUES (2, 'Chang', 1, 1, '24 - 12 oz bottles', 19, 17, 40, 25, true);
INSERT INTO "Products"  VALUES (3, 'Aniseed Syrup', 1, 2, '12 - 550 ml bottles', 10, 13, 70, 25, false);
INSERT INTO "Products"  VALUES (4, 'Chef Anton''s Cajun Seasoning', 2, 2, '48 - 6 oz jars', 22, 53, 0, 0, false);
INSERT INTO "Products"  VALUES (5, 'Chef Anton''s Gumbo Mix', 2, 2, '36 boxes', 21.3500004, 0, 0, 0, true);
INSERT INTO "Products"  VALUES (6, 'Grandma''s Boysenberry Spread', 3, 2, '12 - 8 oz jars', 25, 120, 0, 25, false);
INSERT INTO "Products"  VALUES (7, 'Uncle Bob''s Organic Dried Pears', 3, 7, '12 - 1 lb pkgs.', 30, 15, 0, 10, false);
INSERT INTO "Products"  VALUES (8, 'Northwoods Cranberry Sauce', 3, 2, '12 - 12 oz jars', 40, 6, 0, 0, false);
INSERT INTO "Products"  VALUES (9, 'Mishi Kobe Niku', 4, 6, '18 - 500 g pkgs.', 97, 29, 0, 0, true);
INSERT INTO "Products"  VALUES (10, 'Ikura', 4, 8, '12 - 200 ml jars', 31, 31, 0, 0, false);
INSERT INTO "Products"  VALUES (11, 'Queso Cabrales', 5, 4, '1 kg pkg.', 21, 22, 30, 30, false);
INSERT INTO "Products"  VALUES (12, 'Queso Manchego La Pastora', 5, 4, '10 - 500 g pkgs.', 38, 86, 0, 0, false);
INSERT INTO "Products"  VALUES (13, 'Konbu', 6, 8, '2 kg box', 6, 24, 0, 5, false);
INSERT INTO "Products"  VALUES (14, 'Tofu', 6, 7, '40 - 100 g pkgs.', 23.25, 35, 0, 0, false);
INSERT INTO "Products"  VALUES (15, 'Genen Shouyu', 6, 2, '24 - 250 ml bottles', 13, 39, 0, 5, false);
INSERT INTO "Products"  VALUES (16, 'Pavlova', 7, 3, '32 - 500 g boxes', 17.4500008, 29, 0, 10, false);
INSERT INTO "Products"  VALUES (17, 'Alice Mutton', 7, 6, '20 - 1 kg tins', 39, 0, 0, 0, true);
INSERT INTO "Products"  VALUES (18, 'Carnarvon Tigers', 7, 8, '16 kg pkg.', 62.5, 42, 0, 0, false);
INSERT INTO "Products"  VALUES (19, 'Teatime Chocolate Biscuits', 8, 3, '10 boxes x 12 pieces', 9.19999981, 25, 0, 5, false);
INSERT INTO "Products"  VALUES (20, 'Sir Rodney''s Marmalade', 8, 3, '30 gift boxes', 81, 40, 0, 0, false);
INSERT INTO "Products"  VALUES (21, 'Sir Rodney''s Scones', 8, 3, '24 pkgs. x 4 pieces', 10, 3, 40, 5, false);
INSERT INTO "Products"  VALUES (22, 'Gustaf''s Knäckebröd', 9, 5, '24 - 500 g pkgs.', 21, 104, 0, 25, false);
INSERT INTO "Products"  VALUES (23, 'Tunnbröd', 9, 5, '12 - 250 g pkgs.', 9, 61, 0, 25, false);
INSERT INTO "Products"  VALUES (24, 'Guaraná Fantástica', 10, 1, '12 - 355 ml cans', 4.5, 20, 0, 0, true);
INSERT INTO "Products"  VALUES (25, 'NuNuCa Nuß-Nougat-Creme', 11, 3, '20 - 450 g glasses', 14, 76, 0, 30, false);
INSERT INTO "Products"  VALUES (26, 'Gumbär Gummibärchen', 11, 3, '100 - 250 g bags', 31.2299995, 15, 0, 0, false);
INSERT INTO "Products"  VALUES (27, 'Schoggi Schokolade', 11, 3, '100 - 100 g pieces', 43.9000015, 49, 0, 30, false);
INSERT INTO "Products"  VALUES (28, 'Rössle Sauerkraut', 12, 7, '25 - 825 g cans', 45.5999985, 26, 0, 0, true);
INSERT INTO "Products"  VALUES (29, 'Thüringer Rostbratwurst', 12, 6, '50 bags x 30 sausgs.', 123.790001, 0, 0, 0, true);
INSERT INTO "Products"  VALUES (30, 'Nord-Ost Matjeshering', 13, 8, '10 - 200 g glasses', 25.8899994, 10, 0, 15, false);
INSERT INTO "Products"  VALUES (31, 'Gorgonzola Telino', 14, 4, '12 - 100 g pkgs', 12.5, 0, 70, 20, false);
INSERT INTO "Products"  VALUES (32, 'Mascarpone Fabioli', 14, 4, '24 - 200 g pkgs.', 32, 9, 40, 25, false);
INSERT INTO "Products"  VALUES (33, 'Geitost', 15, 4, '500 g', 2.5, 112, 0, 20, false);
INSERT INTO "Products"  VALUES (34, 'Sasquatch Ale', 16, 1, '24 - 12 oz bottles', 14, 111, 0, 15, false);
INSERT INTO "Products"  VALUES (35, 'Steeleye Stout', 16, 1, '24 - 12 oz bottles', 18, 20, 0, 15, false);
INSERT INTO "Products"  VALUES (36, 'Inlagd Sill', 17, 8, '24 - 250 g  jars', 19, 112, 0, 20, false);
INSERT INTO "Products"  VALUES (37, 'Gravad lax', 17, 8, '12 - 500 g pkgs.', 26, 11, 50, 25, false);
INSERT INTO "Products"  VALUES (38, 'Côte de Blaye', 18, 1, '12 - 75 cl bottles', 263.5, 17, 0, 15, false);
INSERT INTO "Products"  VALUES (39, 'Chartreuse verte', 18, 1, '750 cc per bottle', 18, 69, 0, 5, false);
INSERT INTO "Products"  VALUES (40, 'Boston Crab Meat', 19, 8, '24 - 4 oz tins', 18.3999996, 123, 0, 30, false);
INSERT INTO "Products"  VALUES (41, 'Jack''s New England Clam Chowder', 19, 8, '12 - 12 oz cans', 9.64999962, 85, 0, 10, false);
INSERT INTO "Products"  VALUES (42, 'Singaporean Hokkien Fried Mee', 20, 5, '32 - 1 kg pkgs.', 14, 26, 0, 0, true);
INSERT INTO "Products"  VALUES (43, 'Ipoh Coffee', 20, 1, '16 - 500 g tins', 46, 17, 10, 25, false);
INSERT INTO "Products"  VALUES (44, 'Gula Malacca', 20, 2, '20 - 2 kg bags', 19.4500008, 27, 0, 15, false);
INSERT INTO "Products"  VALUES (45, 'Rogede sild', 21, 8, '1k pkg.', 9.5, 5, 70, 15, false);
INSERT INTO "Products"  VALUES (46, 'Spegesild', 21, 8, '4 - 450 g glasses', 12, 95, 0, 0, false);
INSERT INTO "Products"  VALUES (47, 'Zaanse koeken', 22, 3, '10 - 4 oz boxes', 9.5, 36, 0, 0, false);
INSERT INTO "Products"  VALUES (48, 'Chocolade', 22, 3, '10 pkgs.', 12.75, 15, 70, 25, false);
INSERT INTO "Products"  VALUES (49, 'Maxilaku', 23, 3, '24 - 50 g pkgs.', 20, 10, 60, 15, false);
INSERT INTO "Products"  VALUES (50, 'Valkoinen suklaa', 23, 3, '12 - 100 g bars', 16.25, 65, 0, 30, false);
INSERT INTO "Products"  VALUES (51, 'Manjimup Dried Apples', 24, 7, '50 - 300 g pkgs.', 53, 20, 0, 10, false);
INSERT INTO "Products"  VALUES (52, 'Filo Mix', 24, 5, '16 - 2 kg boxes', 7, 38, 0, 25, false);
INSERT INTO "Products"  VALUES (53, 'Perth Pasties', 24, 6, '48 pieces', 32.7999992, 0, 0, 0, true);
INSERT INTO "Products"  VALUES (54, 'Tourtière', 25, 6, '16 pies', 7.44999981, 21, 0, 10, false);
INSERT INTO "Products"  VALUES (55, 'Pâté chinois', 25, 6, '24 boxes x 2 pies', 24, 115, 0, 20, false);
INSERT INTO "Products"  VALUES (56, 'Gnocchi di nonna Alice', 26, 5, '24 - 250 g pkgs.', 38, 21, 10, 30, false);
INSERT INTO "Products"  VALUES (57, 'Ravioli Angelo', 26, 5, '24 - 250 g pkgs.', 19.5, 36, 0, 20, false);
INSERT INTO "Products"  VALUES (58, 'Escargots de Bourgogne', 27, 8, '24 pieces', 13.25, 62, 0, 20, false);
INSERT INTO "Products"  VALUES (59, 'Raclette Courdavault', 28, 4, '5 kg pkg.', 55, 79, 0, 0, false);
INSERT INTO "Products"  VALUES (60, 'Camembert Pierrot', 28, 4, '15 - 300 g rounds', 34, 19, 0, 0, false);
INSERT INTO "Products"  VALUES (61, 'Sirop d''érable', 29, 2, '24 - 500 ml bottles', 28.5, 113, 0, 25, false);
INSERT INTO "Products"  VALUES (62, 'Tarte au sucre', 29, 3, '48 pies', 49.2999992, 17, 0, 0, false);
INSERT INTO "Products"  VALUES (63, 'Vegie-spread', 7, 2, '15 - 625 g jars', 43.9000015, 24, 0, 5, false);
INSERT INTO "Products"  VALUES (64, 'Wimmers gute Semmelknödel', 12, 5, '20 bags x 4 pieces', 33.25, 22, 80, 30, false);
INSERT INTO "Products"  VALUES (65, 'Louisiana Fiery Hot Pepper Sauce', 2, 2, '32 - 8 oz bottles', 21.0499992, 76, 0, 0, false);
INSERT INTO "Products"  VALUES (66, 'Louisiana Hot Spiced Okra', 2, 2, '24 - 8 oz jars', 17, 4, 100, 20, false);
INSERT INTO "Products"  VALUES (67, 'Laughing Lumberjack Lager', 16, 1, '24 - 12 oz bottles', 14, 52, 0, 10, false);
INSERT INTO "Products"  VALUES (68, 'Scottish Longbreads', 8, 3, '10 boxes x 8 pieces', 12.5, 6, 10, 15, false);
INSERT INTO "Products"  VALUES (69, 'Gudbrandsdalsost', 15, 4, '10 kg pkg.', 36, 26, 0, 15, false);
INSERT INTO "Products"  VALUES (70, 'Outback Lager', 7, 1, '24 - 355 ml bottles', 15, 15, 10, 30, false);
INSERT INTO "Products"  VALUES (71, 'Flotemysost', 15, 4, '10 - 500 g pkgs.', 21.5, 26, 0, 0, false);
INSERT INTO "Products"  VALUES (72, 'Mozzarella di Giovanni', 14, 4, '24 - 200 g pkgs.', 34.7999992, 14, 0, 0, false);
INSERT INTO "Products"  VALUES (73, 'Röd Kaviar', 17, 8, '24 - 150 g jars', 15, 101, 0, 5, false);
INSERT INTO "Products"  VALUES (74, 'Longlife Tofu', 4, 7, '5 kg pkg.', 10, 4, 20, 5, false);
INSERT INTO "Products"  VALUES (75, 'Rhönbräu Klosterbier', 12, 1, '24 - 0.5 l bottles', 7.75, 125, 0, 25, false);
INSERT INTO "Products"  VALUES (76, 'Lakkalikööri', 23, 1, '500 ml', 18, 57, 0, 20, false);
INSERT INTO "Products"  VALUES (77, 'Original Frankfurter grüne Soße', 12, 2, '12 boxes', 13, 32, 0, 15, false);
...
INSERT INTO "Suppliers" VALUES (12, 'Plutzer Lebensmittelgroßmärkte AG', 'Martin Bein', 'International Marketing Mgr.', 'Bogenallee 51', 'Frankfurt', NULL, '60439', 'Germany', '(069) 992755', NULL, 'Plutzer (on the World Wide Web)#http://www.microsoft.com/accessdev/sampleapps/plutzer.h"t"m#');
...
INSERT INTO "Suppliers" VALUES (24, 'G''day, Mate', 'Wendy Mackenzie', 'Sales Representative', '170 Prince Edward Parade Hunter''s Hill', 'Sydney', 'NSW', '2042', 'Australia', '(02) 555-5914', '(02) 555-4873', 'G''day Mate (on the World Wide Web)#http://www.microsoft.com/accessdev/"sampleapp"s/gdaymate.htm#');
...
ALTER TABLE ONLY "CustomerCustomerDemo"
    ADD CONSTRAINT pk_customer_customer_demo PRIMARY KEY ("CustomerID", "CustomerTypeID");
...
ALTER TABLE ONLY "EmployeeTerritories"
    ADD CONSTRAINT pk_employee_territories PRIMARY KEY ("EmployeeID", "TerritoryID");
...
ALTER TABLE ONLY "CustomerCustomerDemo"
    ADD CONSTRAINT fk_customer_customer_demo_customer_demographics FOREIGN KEY ("CustomerTypeID") REFERENCES "CustomerDemographics";
...
ALTER TABLE ONLY "CustomerCustomerDemo"
    ADD CONSTRAINT fk_customer_customer_demo_customers FOREIGN KEY ("CustomerID") REFERENCES "Customers";
