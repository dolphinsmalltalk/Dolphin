	...
	case TokenType::NameConst:
		{
			...
			static ArgTypeDefn argTypes[] =	{
				...
				{ u8"variant", DolphinX::ExtCallArgType::Variant, (LPUTF8)"VARIANT" },
				{ u8"varbool", DolphinX::ExtCallArgType::VarBool, (LPUTF8)DolphinX::ExtCallArgType::LPVoid },
				{ u8"guid", DolphinX::ExtCallArgType::Guid, (LPUTF8)"REFGUID" },
				{ u8"date", DolphinX::ExtCallArgType::Date, (LPUTF8)"DATE" },
				...
				{ u8"GUID", DolphinX::ExtCallArgType::Guid, (LPUTF8)"REFGUID" },
				{ u8"IID", DolphinX::ExtCallArgType::Guid, (LPUTF8)"REFGUID" },
				{ u8"CLSID", DolphinX::ExtCallArgType::Guid, (LPUTF8)"REFGUID" },
