...
extern "C" PRIMTABLEDECL Interpreter::PrimitiveFp primitivesTable[256] = {
	...
	Interpreter::primitiveIntegerAbs											, // case 108: Integer>>#abs
	...
	Interpreter::primitiveStringDecodeAt									, // case 225: Utf8String>>decodeAt:
	Interpreter::primitiveStringEncodedSizeAt								, // case 226: Utf8String>>encodedSizeAt:
