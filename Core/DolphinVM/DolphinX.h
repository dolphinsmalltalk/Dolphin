...
namespace DolphinX {
	...
	enum class ExtCallArgType : uint8_t {
		...
		LPPVoid,			//15
		HResult,			//16
		LPWStr,				//17	OLECHAR*, Utf16 string
		...
		Bool8,				//30	8-bit boolean return code (0 false, non-zero true)
		Char32,				//31	char32_t, UTF-32 code point
		Char16,				//32	char16_t, UTF-16 code unit
							//33	Reserved for char8_t, UTF-8 code unit
							//34	Reserved for UTF-8 string
							//35
							//36
							//37
							//38
