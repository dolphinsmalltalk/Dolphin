...
/**/Oop _unusedSelector3;								// 69
	...
	// 81..90
	BehaviorOTE* ClassMetaclass;
	BehaviorOTE* ClassCharacter;
	BehaviorOTE* ClassArray;
	BehaviorOTE* ClassString;
	BehaviorOTE* ClassSymbol;
	BehaviorOTE* ClassSmallInteger;
	BehaviorOTE* ClassProcess;
	BehaviorOTE* ClassCompiledMethod;
	BehaviorOTE* ClassContext;
	BehaviorOTE* ClassBlockClosure;

	// 91..100
	BehaviorOTE* ClassMessage;								// 91
	BehaviorOTE* ClassByteArray;							// 92
	BehaviorOTE* ClassUnicodeString;						// 93 - These two previously LPI and LNI
